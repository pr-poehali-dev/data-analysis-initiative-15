...
const services = [
  {
    ...
    description:
      "Регулярная уборка квартир и домов: влажная уборка, пылесос, мытье полов. Поддерживаем чистоту еженедельно или по графику.",
    mockup: "social",
  },
  {
    title: "Генеральная уборка",
    description:
      "Комплексная глубокая уборка всех помещений: мытье окон, чистка мебели, санузлов, кухни. Идеально после ремонта.",
    mockup: "google-ads",
  },
  {
    title: "Уборка после ремонта",
    description: "Удаление строительной пыли, мытье окон, полов, радиаторов. Подготовка помещения к заселению.",
    mockup: "email",
  },
  {
    title: "Химчистка мебели",
    description:
      "Профессиональная чистка диванов, кресел, матрасов. Удаление пятен, пыли и аллергенов с помощью безопасных средств.",
    mockup: "seo",
  },
  {
    title: "Мытье окон",
    description:
      "Профессиональное мытье окон с внутренней и внешней стороны, рам и подоконников. Без разводов и пятен.",
    mockup: "analytics",
  },
  {
    title: "Уборка офисов",
    description:
      "Ежедневная или разовая уборка офисных помещений: кабинеты, переговорные, санузлы. Работаем в удобное время.",
    mockup: "web-dev",
    badges: [
      { icon: <Shield className="w-4 h-4" />, text: "Эко-средства" },
      { icon: <DollarSign className="w-4 h-4" />, text: "Фикс. цена" },
      { icon: <CheckCircle className="w-4 h-4" />, text: "Гарантия" },
    ],
  },
]
  ...
  return (
    <section id="services" className="py-24 bg-black relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6">Все виды клининговых услуг</h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Профессиональная уборка для дома, квартиры и офиса. Безопасные средства и гарантия качества.
          </p>
        </motion.div>
